...
const { atyping } = require(__dirname + '/SIGMA_MD_DB/atyping')
const { arecording } = require(__dirname + '/SIGMA_MD_DB/recording')
const { aonline } = require(__dirname + '/SIGMA_MD_DB/online')
